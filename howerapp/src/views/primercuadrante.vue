<template>
    <div class=primercuadrante>
        <div class="title3">
       <img class="fadeIn first" src="@/assets/tit5.png" id="icon" alt="User Icon" />
      </div>
      <div class="textito fadeIn second">
       <b>{{nombre}} Las tareas de este cuadrante son Urgentes e Importantes, son Tareas que finalizan hoy o Mañana. Nuestra meta es no tener Tareas aqui!</b>
      </div>
    <div class="header">
       ...
       <drag  v-for="(elemento1,idx) in gettask_drag" :key="elemento1" :class="vision_drag" :data="elemento1" @cut="remove(idx)">                                                       
        ...
        <div class="avatar">
              <div class="top-products">
                  ...
                  <div class="top-products-text">
                      <div class="top-products-title">No Tienes mas Tareas por Hacer</div>
                      <div class="fecha"></div>
...
export default {
    ...
    methods:{
        iniciar(){
          ...
          axios.post("https://howerapp.herokuapp.com/gettask","username=" + Vue.$cookies.get("usuario")+"&clasificacion=1")
          .then(res => {
